...
\textbf{2.2 The Bogoliubov-de Gennes Formalism:} Introduce the BdG Hamiltonian as the  mathematical tool for describing quasiparticles in systems where superconductivity varies in space (like at an interface). Important for numerical work later.\\
